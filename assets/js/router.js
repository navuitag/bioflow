  ...
  return `
    <main class="onboarding">
      <section class="onboarding-card">
        ...
        <span class="eyebrow">Chào mừng đến BioFlow VN</span>
    ...
    : "Chọn lớp để mở đúng lộ trình Sinh học THCS. Bạn có thể đổi lớp bất cứ lúc nào trên thanh điều hướng."}</p>
        ${isNewAccount ? `
...
function renderHome(state) {
  ...
  return `
    <section class="summer-banner st-home-banner">
      <div>
        <span class="tag">Chuyên đề · ${data.specialTopics?.meta?.topicCount || 7} chủ đề</span>
        <h2>Tài liệu chuyên đề Sinh — xem sơ đồ trực tiếp</h2>
        <p>Tế bào, thực vật, động vật, di truyền, sinh thái… sơ đồ tư duy đầy đủ cho THCS.</p>
      </div>
    ...
    <section class="hero-panel">
      <div>
        ...
        <h1>Học Sinh học mỗi ngày, hiểu rõ từng lỗi sai.</h1>
        <p>Hoàn thành một bài ngắn, luyện vài câu và xem ngay vì sao khái niệm hoặc mô hình sinh vật chưa đúng.</p>
...
function renderSkills(state) {
  ...
  return `
    <section class="page-title">
      ...
      <h1>Cây kỹ năng Sinh học THCS</h1>
...
function renderErrors(state) {
  ...
  return `
    <section class="page-title">
      ...
      <p>Ứng dụng lưu lỗi gần đây để gợi ý bài cần ôn — đặc biệt khi nhầm quang hợp, hô hấp, tuần hoàn hoặc di truyền.</p>
    </section>
